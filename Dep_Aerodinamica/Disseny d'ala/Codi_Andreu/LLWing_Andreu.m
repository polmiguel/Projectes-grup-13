...
YF_pos = [ 0.2 0.5 ]; % 2y/b initial and final position of the flap/aileron in the half-wing
CF_ratio = 0.2 ;  % flap_chord/chord ratio
DE_flap = 3; % flap deflection (deg, positive:down)
...
for valor = 0.5:0.1:2
    ...
    for valor2 = 15:1:27
        ...
        mat_eff(i,j) = force_coeff (7 ,6)/force_coeff(11,6); % CANVIAR EL "6" SEGONS ANGLE D'ATAC DE LA CONDICIÓ DE VOL 
...
Clmax = 1.35; % angle stall reynolds 6.5*10^6 aprox
